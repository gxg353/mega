...
SECRET_KEY = 'xc+x%70&amp;#t*=)rwpwm)#m)9%v5exwzc_60=+))32%@)8vfrxn4'
...
ROOT_URLCONF = 'mega_web.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'mega_web.wsgi.application'

TEMPLATE_DIRS = (
    #"/Users/xchliu/Documents/workspace/mega/src/mega/mega_web/templates/"
...
LOGGING = {
    ...
    'handlers': {
        'api': {
            ...
            'formatter': 'simple',
            'filename':  os.path.join(PROJECT_PATH, 'logs/api.log'),
        }
    },
    'loggers': {
        'django.request': {
